...
class_names = [c.strip() for c in open('./data/labels/bdd.names').readlines()]
...
#    img_in = transform_images(img_in, 416)
    ...
    converted_boxes, scores, classes, nums = det.get_localization(img_in)
...
#    detections = [detections[i] for i in indices]
    ...
    for track in tracker.tracks:
        ...
        conf = -1
        print('{},{},{},{},{},{},{},-1,-1,-1'.format(frame_num, int(track.track_id), x1, y1, width, height, conf),
              file=ht_file)
